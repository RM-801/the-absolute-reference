...
#define BONE_BLOCK_STYLE_COUNT 4u
#define BONE_BLOCK_TILE_COUNT (BONE_BLOCK_STYLE_COUNT * BONE_BLOCK_BORDER_COUNT)
...
#define BONE_BLOCK_CLASSIC_PREVIEW_TILE (BONE_BLOCK_WORLD_TILE + BONE_BLOCK_BORDER_COUNT)
#define BONE_BLOCK_WORLD_PREVIEW_TILE (BONE_BLOCK_CLASSIC_PREVIEW_TILE + BONE_BLOCK_BORDER_COUNT)
#define SHIRASE_LABEL_TILE_COUNT 8u
#define SHIRASE_LABEL_TILE_BASE (BONE_BLOCK_CLASSIC_TILE + BONE_BLOCK_TILE_COUNT)
#define SHIRASE_GRADE_TILE_COUNT (4u * 3u * 2u)
#define SHIRASE_GRADE_TILE_BASE (SHIRASE_LABEL_TILE_BASE + SHIRASE_LABEL_TILE_COUNT)

extern uint8_t* TileData;
extern Color WorldBlockPalette[NUMPALCOLORS_8BPP];
extern Color ShiraseGradePalette[NUMPALCOLORS_8BPP];
bool OpenTileData();
void CloseTileData();
